...
> Placeholder name. Every occurrence of `Connections` is a find-and-replace token.
...
Connections takes both further and removes the contradiction:
...
incentives), each paired with what Connections does instead.
...
See `README.md` for the current file list and the assignment write-up.
